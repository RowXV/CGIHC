...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		modelaux = model; // Utilizo mi matriz auxiliar
		...
		sp.render(); // Se pone aqui para que se vea adecuadamente

		model = modelaux; // Descarto la matriz auxiliar
		...
		model = glm::translate(model, glm::vec3(3.0f, 0.0f, 0.0f)); // Translate despues del rotate para que gire al rededor de la esfera
